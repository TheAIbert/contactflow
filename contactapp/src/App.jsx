...
export default function App() {
  ...
  const updateImage = async (fromData) => {
    try {
      const { data: photoUrl } = await updatePhoto(fromData);
    } catch (error) {
      console.log(error);
      toastError(error.message);
    }
      ...
      <main className="main">
        <div className="container">
          <Routes>
            ...
            <Route path="/contacts/:id" element={<ContactDetail updateContact={updateContact} updateImage={updateImage} refreshPage={refreshPage} />} />
          </Routes>
        </div>
      </main>
