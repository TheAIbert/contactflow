package io.contactflow.contactapi.resource;

import io.contactflow.contactapi.domain.Contact;
import io.contactflow.contactapi.service.ContactService;
...
public class ContactResource {
    ...
    public ResponseEntity<String> deleteContact(@PathVariable(value = "id") String id) {
        ...
        return ResponseEntity.ok("Contact successfully deleted by provided ID: " + id);
    }
}
